...
import net.minebo.mcraidz.deathmessage.damage.MobDamage;
...
public final class ArrowTracker implements Listener {
    ...
    public void onEntityShootBow(EntityShootBowEvent event) {
        if (event.getEntity() instanceof Player) {
            event.getProjectile().setMetadata("ShotFromDistance", new FixedMetadataValue(MCRaidz.instance, event.getProjectile().getLocation()));
        }
    }
    ...
    public static class ArrowDamageByMob extends MobDamage {
        ...
        public String getDeathMessage(UUID getFor) {
            return ArrowDamageByMob.wrapName(this.getDamaged(), getFor) + ChatColor.YELLOW + " was shot by a " + ChatColor.RED + this.getMobType().name() + ChatColor.YELLOW + ".";
        }
    }
